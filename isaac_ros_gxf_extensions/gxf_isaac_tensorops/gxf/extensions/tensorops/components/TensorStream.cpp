...
gxf::Expected<cvcore::tensor_ops::ComputeEngine> GetComputeEngineType(const std::string& type) {
  if (type == "UNKNOWN") {
    return  cvcore::tensor_ops::ComputeEngine::UNKNOWN;
  } else if (type == "CPU") {
    return  cvcore::tensor_ops::ComputeEngine::CPU;
  } else if (type == "PVA") {
